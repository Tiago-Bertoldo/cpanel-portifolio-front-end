                  ...
                  <form action="" onSubmit={handleSubmit(handleTecnologie)}>
                    <aside className="container-form__left">
                      ...
                      {errors.url?.type === "required" && (
                        <p role="alert">Url is required</p>
                      )}
                      ...
                      <div className="input-tech">
                        <input
                          ...
                          name="techonologie"
                          id="techonologie"
                          className="techonologie"
                          placeholder="Javascript et React..."
                        ...
                        />
                        <button
                          className="btn-effect-more"
                          onClick={(e) => handleAddInput(e)}
                        >
                          <AiOutlinePlus />
                        </button>
                        <button
                          className="btn-effect-moins"
                          onClick={(e) => handleRemoveInput(e)}
                        >
                          <AiOutlineMinus />
                        </button>
                        {errors.techonologie?.type === "required" && (
                          <p role="alert">Techonologie is required</p>
                        )}
                      </div>
